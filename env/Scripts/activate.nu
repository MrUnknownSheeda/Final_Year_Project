...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Fahad\Desktop\Stock Market Analyzer\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Fahad\Desktop\Stock Market Analyzer\env\Scripts\deactivate.nu'
